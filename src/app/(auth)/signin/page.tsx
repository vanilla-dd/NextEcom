  ...
  return (
    <div className="flex min-h-dvh w-full flex-col items-center justify-center px-4">
      <div className="w-full max-w-96">
        ...
        <div className="flex w-full flex-col items-center gap-3">
          ...
          >
            <button
              type="submit"
              className="relative inset-0 flex w-full items-center justify-center gap-4 rounded-md border-2 border-gray-500 px-8 py-1.5 text-sm font-semibold focus-within:ring-2 focus-within:ring-black focus-within:ring-offset-2"
            >
              <svg
                viewBox="-3 0 262 262"
      ...
      <p className="py-3 text-sm">
        ...
        <Link href={"/signup"} className="font-medium text-purple-500">
          {" "}
          Register Now.
        </Link>
      </p>
